...
import static com.amazon.sdkv2.sqs.javamessaging.SQSMessagingClientConstants.JMSX_DELIVERY_COUNT;
...
public class SQSMessageTest {
    ...
    public void testSQSMessageAttributeToProperty() throws JMSException {
        ...
        Map<MessageSystemAttributeName,String> systemAttributes = new HashMap<MessageSystemAttributeName, String>();
        systemAttributes.put(MessageSystemAttributeName.APPROXIMATE_RECEIVE_COUNT, "100");
